...
def reset():
    ...
    classic_starting = {(0, 0): None, (0, 1): None, (0, 2): None, (0, 3): None, (0, 4): pyg.image.load(rsob.image),
                        (0, 5): pyg.image.load(rpha.image),
                        (0, 6): pyg.image.load(rsob.image), (0, 7): pyg.image.load(rpyr_SE.image), (0, 8): None,
                        (0, 9): None,
                        (1, 0): None, (1, 1): None, (1, 2): pyg.image.load(rpyr_SW.image), (1, 3): None, (1, 4): None,
                        (1, 5): None,
                        (1, 6): None, (1, 7): None, (1, 8): None, (1, 9): None, (2, 0): None, (2, 1): None,
                        (2, 2): None,
                        (2, 3): pyg.image.load(spyr_NW.image), (2, 4): None, (2, 5): None, (2, 6): None, (2, 7): None,
                        (2, 8): None, (2, 9): None,
                        (3, 0): pyg.image.load(rpyr_NE.image), (3, 1): None, (3, 2): pyg.image.load(spyr_SW.image),
                        (3, 3): None,
                        ...
                        (4, 0): pyg.image.load(rpyr_SE.image), (4, 1): None, (4, 2): pyg.image.load(spyr_NW.image),
                        (4, 3): None,
                        ...
                        (5, 6): pyg.image.load(rpyr_SE.image),
                        (5, 7): None, (5, 8): None, (5, 9): None, (6, 0): None, (6, 1): None, (6, 2): None,
                        (6, 3): None, (6, 4): None, (6, 5): None,
                        (6, 6): None, (6, 7): pyg.image.load(spyr_NE.image), (6, 8): None, (6, 9): None, (7, 0): None,
                        (7, 1): None,
                        (7, 2): pyg.image.load(spyr_NW.image), (7, 3): pyg.image.load(ssob.image),
                        (7, 4): pyg.image.load(spha.image),
    ...
    if classic_board[y][x] != 0 and (classic_board[y][x].type == 'pyr' or
        ...
        if classic_board[node.row][node.col].team == 's':
            if (node.row!=y or node.col != x) or sob_special:
                ...
                set_board_image(x,y ,pyg.transform.smoothscale(pyg.image.load(ssob.image),
                                                       (node.piece_width, node.piece_height)))
            else:
                classic_board[y][x] = sob
                set_board_image(x, y, pyg.transform.smoothscale(pyg.image.load(sob.image),
                                                                (node.piece_width, node.piece_height)))
            ...
            if (node.row!=y or node.col != x) or sob_special:
                ...
                set_board_image(x,y ,pyg.transform.smoothscale(pyg.image.load(rsob.image),
                                                       (node.piece_width, node.piece_height)))
            else:
                classic_board[y][x] = rob
                set_board_image(x, y, pyg.transform.smoothscale(pyg.image.load(rob.image),
                                                                (node.piece_width, node.piece_height)))
        ...
        if sob_special:
            if classic_board[node.row][node.col].team == 's':
                ...
                set_board_image(node.col, node.row, pyg.transform.smoothscale(pyg.image.load(ssob.image),
                                                                (node.piece_width, node.piece_height)))

            elif classic_board[node.row][node.col].team == 'r':
                classic_board[node.row][node.col] = rsob
                set_board_image(node.col, node.row, pyg.transform.smoothscale(pyg.image.load(rsob.image),
                                                                    (node.piece_width, node.piece_height)))
        return False
    else:
...
def sob_dragged_node(x,y,current_p):
    ...
    simg = pyg.image.load(sob.image)
    rimg = pyg.image.load(rob.image)
                    ...
                    if laser_fired:
                        ...
                        if hit_x is not None and hit_y is not None:
                            if classic_board[hit_y][hit_x].type == 'pyr' or classic_board[hit_y][hit_x].type == 'ob':
                                ...
                                if classic_board[hit_y][hit_x].team == 'r':
                                    vs = pyg.image.load(dir.joinpath("images/silver_victory.png"))
                                    vs = pyg.transform.smoothscale(vs, (WIDTH, HEIGHT))
                                    WIN.blit(vs, (0, 0))
                                    pyg.display.flip()
                                    victor = True
                                elif classic_board[hit_y][hit_x].team == 's':
                                    vs = pyg.image.load(dir.joinpath("images/red_victory.png"))
                                    vs = pyg.transform.smoothscale(vs, (WIDTH, HEIGHT))
                                    WIN.blit(vs, (0, 0))
                                    pyg.display.flip()
                                    victor = True
